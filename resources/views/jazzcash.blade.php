  ...
  <style>
                                        ...
                                        <div class="jsformWrapper">
                                            <form name="jsform" method="post" action="{{$postURL}}">
                                                {{ csrf_field() }}
                                                <input type="hidden" name="pp_Version" value="{{$aData['pp_Version']}}">
                                                <input type="hidden" name="pp_TxnType" value="{{$aData['pp_TxnType']}}">
                                                <input type="hidden" name="pp_Language" value="{{$aData['pp_Language']}}">
                                                <input type="hidden" name="pp_MerchantID" value="{{$aData['pp_MerchantID']}}">
                                                <input type="hidden" name="pp_SubMerchantID" value="{{$aData['pp_SubMerchantID']}}">
                                                <input type="hidden" name="pp_Password" value="{{$aData['pp_Password']}}">
                                                <input type="hidden" name="pp_BankID" value="{{$aData['pp_BankID']}}">
                                                <input type="hidden" name="pp_ProductID" value="{{$aData['pp_ProductID']}}">

                                                <div class="formFielWrapper">
                                                    <label class="active">pp_TxnRefNo: </label>
                                                    <input type="text" name="pp_TxnRefNo" id="pp_TxnRefNo"  value="{{$aData['pp_TxnRefNo']}}">
                                                </div>

                                                <div class="formFielWrapper">
                                                    <label class="active">pp_Amount: </label>
                                                    <input type="text" name="pp_Amount"   value="{{$aData['pp_Amount']}}">
                                                </div>

                                                <input type="hidden" name="pp_TxnCurrency"  value="{{$aData['pp_TxnCurrency']}}">
                                                <input type="hidden" name="pp_TxnDateTime"  value="{{$aData['pp_TxnDateTime']}}">
                                                <div class="formFielWrapper">
                                                    <label class="active">pp_BillReference: </label>
                                                    <input type="text" name="pp_BillReference"  value="{{$aData['pp_BillReference']}}">
                                                </div>

                                                <div class="formFielWrapper">
                                                    <label class="active">pp_Description: </label>
                                                    <input type="text" name="pp_Description"  value="{{$aData['pp_Description']}}">
                                                </div>

                                                <input type="hidden" name="pp_TxnExpiryDateTime"  value="{{$aData['pp_TxnExpiryDateTime']}}">

                                                <div class="formFielWrapper">
                                                    <label class="active">pp_ReturnURL: </label>
                                                    <input type="text" name="pp_ReturnURL"  value="{{$aData['pp_ReturnURL']}}">
                                                </div>

                                                <input type="hidden" name="pp_SecureHash" value="{{$aData['pp_SecureHash']}}">
                                                <input type="hidden" name="ppmpf_1" value="{{$aData['ppmpf_1']}}">
                                                <input type="hidden" name="ppmpf_2" value="{{$aData['ppmpf_2']}}">
                                                <input type="hidden" name="ppmpf_3" value="{{$aData['ppmpf_3']}}">
                                                <input type="hidden" name="ppmpf_4" value="{{$aData['ppmpf_4']}}">
                                                <input type="hidden" name="ppmpf_5" value="{{$aData['ppmpf_5']}}">
                                                <button type="button" onclick="submitForm()">Submit</button>
                                            </form>

                                            <label id="salt" style="display:none;">t3xczx5hed</label>
                                            <br><br>
                                            <div class="formFielWrapper">
                                                <label class="">Hash values string: </label>
                                                <input type="text" id="hashValuesString"  value="{{$aData['pp_SecureHash']}}">
                                                <br><br>
                                            </div>
